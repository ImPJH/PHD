...
for seed in $seeds; do
    ...
    python main.py --mode partial --trials $TRIALS --action_spaces $M --num_actions 10 20 30 40 --obs_dim $d --latent_dim $k --lbda 5 --num_visibles 1 --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method scaling --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
    python main.py --mode partial --trials $TRIALS --action_spaces $M --num_actions 10 20 30 40 --obs_dim $d --latent_dim $k --lbda 5 --num_visibles $half --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method scaling --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
    python main.py --mode partial --trials $TRIALS --action_spaces $M --num_actions 10 20 30 40 --obs_dim $d --latent_dim $k --lbda 5 --num_visibles $almost --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method scaling --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
