...
for seed in $seeds; do
    ...
    python compare.py --mode partial --alphas 1.0 --trials $TRIALS --action_spaces $M --num_actions $K --obs_dim $d --latent_dim $k --num_visibles 1 --horizon $T --seed "$seed" --feat_dist uniform --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist uniform --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
    python compare.py --mode partial --alphas 1.0 --trials $TRIALS --action_spaces $M --num_actions $K --obs_dim $d --latent_dim $k --num_visibles $half --horizon $T --seed "$seed" --feat_dist uniform --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist uniform --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
    python compare.py --mode partial --alphas 1.0 --trials $TRIALS --action_spaces $M --num_actions $K --obs_dim $d --latent_dim $k --num_visibles $almost --horizon $T --seed "$seed" --feat_dist uniform --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist uniform --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
