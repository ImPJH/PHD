...
def get_cfg():
    ...
    ## For Bilinear model
    parser.add_argument("--arm_x", "-M", type=int, default=3)
    parser.add_argument("--arm_y", "-N", type=int, default=3)
    parser.add_argument("--true_dim_x", "-tx", type=int, default=7)
    parser.add_argument("--true_dim_y", "-ty", type=int, default=7)
