...
seeds=$(python3 get_primes.py --nums 43 50)
...
for seed in $seeds; do
    ...
    # python main.py --mode full --trials $TRIALS --action_spaces $M --num_actions 10 15 20 25 30 --obs_dim $d --latent_dim $k --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method scaling --map_dist uniform --map_upper_bound 1 --context_std 0 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
    # python main.py --mode full --trials $TRIALS --action_spaces $M --num_actions 10 15 20 25 30 --obs_dim $d --latent_dim $k --num_visibles $half --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method scaling --map_dist uniform --map_upper_bound 1 --context_std 0 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
    # python main.py --mode full --trials $TRIALS --action_spaces $M --num_actions 10 15 20 25 30 --obs_dim $d --latent_dim $k --num_visibles $almost --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method scaling --map_dist uniform --map_upper_bound 1 --context_std 0 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode
