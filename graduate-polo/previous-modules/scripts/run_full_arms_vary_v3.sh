...
for seed in $seeds; do
    ...
    echo "Context fixed"
    python main_vary.py --mode full --trials $TRIALS --action_spaces $M --num_actions 10 20 30 40 --obs_dim $d --latent_dim $k --horizon $T --seed "$seed" --feat_dist gaussian --feat_cov_dist gaussian --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method scaling --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist uniform --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode --fixed --delta 0.001
    python main_vary.py --mode full --trials $TRIALS --action_spaces $M --num_actions 10 20 30 40 --obs_dim $d --latent_dim $k --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method scaling --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist uniform --param_bound 1 --param_disjoint --bias_dist gaussian --check_specs --seed_mode --fixed --delta 0.001
