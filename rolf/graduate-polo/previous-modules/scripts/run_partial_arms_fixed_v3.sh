...
seeds=$(python3 get_primes.py --nums 6000 10000)
...
d=15 # dimension of "mapped" features
...
for seed in $seeds; do
    echo "Partial Mode"
    python main_fixed.py --mode partial --alphas 0.3 --trials $TRIALS --action_spaces $M --num_actions 5 10 20 30 --obs_dim $d --latent_dim $k --num_visibles 1 --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --check_specs --seed_mode
    python main_fixed.py --mode partial --alphas 0.3 --trials $TRIALS --action_spaces $M --num_actions 5 10 20 30 --obs_dim $d --latent_dim $k --num_visibles $half --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --check_specs --seed_mode
    python main_fixed.py --mode partial --alphas 0.3 --trials $TRIALS --action_spaces $M --num_actions 5 10 20 30 --obs_dim $d --latent_dim $k --num_visibles $almost --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --check_specs --seed_mode
done
...
for seed in $seeds; do
    echo "Partial Mode"
    python main_fixed.py --mode partial --alphas 0.3 --trials $TRIALS --action_spaces $M --num_actions 5 10 20 30 --obs_dim $d --latent_dim $k --num_visibles 1 --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std 0 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --check_specs --seed_mode
    python main_fixed.py --mode partial --alphas 0.3 --trials $TRIALS --action_spaces $M --num_actions 5 10 20 30 --obs_dim $d --latent_dim $k --num_visibles $half --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std 0 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --check_specs --seed_mode
    python main_fixed.py --mode partial --alphas 0.3 --trials $TRIALS --action_spaces $M --num_actions 5 10 20 30 --obs_dim $d --latent_dim $k --num_visibles $almost --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std 0 --reward_std 0.1 --param_dist gaussian --param_bound 1 --param_disjoint --check_specs --seed_mode
done