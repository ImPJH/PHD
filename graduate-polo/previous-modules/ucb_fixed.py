...
if __name__ == "__main__":
    ...
    PATH = "/home/sungwoopark/bandit-research/latent-contextual-bandit/modules/seed_comparison2/figures/UCB/arms_fixed"
    
    for seed in SEED:
        num_actions = [5] + [10*(i+1) for i in range(3)]
        regret_results = dict()
        for n_arms in num_actions:
            print(f"SEED = {seed}\t|A_t| = {n_arms}")
            random_state = seed + int(11111*ALPHA) + (11111*n_arms)
