...
for seed in $seeds; do
    ...
    python main_v3.py --mode partial --alphas 0.3 --trials $TRIALS --action_spaces $M --num_actions 10 20 30 40 50 --obs_dim $d --latent_dim $k --num_visibles $half --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist uniform --param_bound 1 --param_uniform_rng -1 1 --param_disjoint --check_specs --seed_mode
    python main_v3.py --mode partial --alphas 0.3 --trials $TRIALS --action_spaces $M --num_actions 10 20 30 40 50 --obs_dim $d --latent_dim $k --num_visibles $almost --horizon $T --seed "$seed" --feat_dist gaussian --feat_disjoint --latent_feature_bound 1 --obs_feature_bound 1 --latent_bound_method clipping --map_dist uniform --map_upper_bound 1 --context_std T-0.5 --reward_std 0.1 --param_dist uniform --param_bound 1 --param_uniform_rng -1 1 --param_disjoint --check_specs --seed_mode
done
