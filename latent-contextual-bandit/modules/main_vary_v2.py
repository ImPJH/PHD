...
if __name__ == "__main__":
    ...
    if cfg.seed_mode:
        RESULT_PATH = f"{MOTHER_PATH}/seed_comparison3/results/{PATH_DICT[(cfg.mode, path_flag)]}"
        FIGURE_PATH = f"{MOTHER_PATH}/seed_comparison3/figures/{PATH_DICT[(cfg.mode, path_flag)]}"
    else:
