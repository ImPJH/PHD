...
if __name__ == "__main__":
    ...
    # AGENTS = ["linucb", "lints", "mab_ucb"]

    RESULT_PATH = f"{MOTHER_PATH}/results_v2/seed_{cfg.seed}_p_{cfg.p}_std_{cfg.reward_std}"
    FIGURE_PATH = f"{MOTHER_PATH}/figures_v2/seed_{cfg.seed}_p_{cfg.p}_std_{cfg.reward_std}"
