...
MOTHER_PATH = "/home/sungwoopark/bandit-research/latent-contextual-bandit/hybrid"
...
def run(mode:str, simple_agent:UCB, complex_agent:LinUCB, horizon:int, action_size:int, arms:int, 
    ...
    for t in bar:
        if t <= num_actions:
            ...
            reward = inherent_rewards + np.random.normal(loc=0, scale=noise_std)
